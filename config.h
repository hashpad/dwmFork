...
//"Material Design Icons:Regular:pixelsize=16:antialias=true",
//"Noto Color Emoji:pixelsize=12:antialias=true"};
...
static char *colors[][3] = {
    ...
    [SchemeStatus] = {fgSchemeStatus, bgSchemeStatus,
                      bdSchemeStatus}, // Statusbar right {text,background,not
                                       // used but cannot be empty}
    [SchemeTagsSel] =
        {fgSchemeTagSel, bgSchemeTagSel,
         bdSchemeTagSel}, // Tagbar left selected {text,background,not used but
                          // cannot be empty}
    [SchemeTagsNorm] =
        {fgSchemeTagsNorm, bgSchemeTagsNorm,
         bdSchemeTagsNorm}, // Tagbar left unselected {text,background,not used
                            // but cannot be empty}
    [SchemeInfoSel] =
        {fgSchemeInfoSel, bgSchemeInfoSel,
         bdSchemeInfoSel}, // infobar middle  selected {text,background,not used
                           // but cannot be empty}
    [SchemeInfoNorm] =
        {fgSchemeInfoNorm, bgSchemeInfoNorm,
         bdSchemeInfoNorm}, // infobar middle  unselected {text,background,not
                            // used but cannot be empty}
    [SchemeWarn] = {fgSchemeStatus, bgSchemeStatus, bdSchemeStatus},
    [SchemeUrgent] = {fgSchemeTagSel, bgSchemeTagSel, bdSchemeTagSel},
};
...
static Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3) TAGKEYS(
        XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
        TAGKEYS(XK_9, 8){ControlMask | SUPERKEY | ShiftMask, XK_q, quit, {0}},
};
